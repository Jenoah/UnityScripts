...
{
    [Header("Position")]
    [SerializeField] private float positionalStrength = .1f;
    [SerializeField] private float positionalMaxStrength = .125f;
    [SerializeField] private float positionalSmoothing = 6f;

    [Header("Rotation")]
    [SerializeField] private float rotationalStrength = 4f;
    ...
    [SerializeField] private float shakeStrength = 0.0125f;
